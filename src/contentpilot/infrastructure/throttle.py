...
Problem: N bot profiles concurrent → single endpoint 127.0.0.1:20128 → 429/empty-stream cascade.
...
Usage:
    ...
    client = ThrottledClient(base_url="http://127.0.0.1:20128/v1", max_concurrent=2)
