...
2. **Research Phase**
   - **PENTING**: Tools = alat, bukan tujuan. Research harus RELEVAN dengan blog!
   - Cari topik yang sesuai content pillars blog
   - Pastikan audience butuh info ini
   - Jangan research topik yang gak relevan cuma karena tools bisa
   
   - **Exa Search**: Semantic search untuk topik, Reddit, competitor
   - **YouTube**: Extract transcript competitor videos
   - **Bilibili**: Riset content China (trend, angle berbeda)
   - **Xiaohongshu**: Product reviews, trend China
   - **Blogwatcher**: Monitor competitor blogs
   - **arXiv**: Academic sources
   - Verify technical accuracy
   - Find official documentation
**Filter Relevansi:**
- [ ] Topik sesuai content pillars blog?
- [ ] Audience butuh info ini?
- [ ] Ada search volume?
- [ ] Bisa kasih value unik?

**Research tools tersedia di server.**
Server akan handle semua research capability.
