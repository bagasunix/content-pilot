...
Usage:
    python3 python3 -m contentpilot.cli.check_duplicate "Cara Install Redis di Ubuntu"
    python3 python3 -m contentpilot.cli.check_duplicate --list  # list all existing articles
"""
